 $(function(){ 
	 ...
	 $('.zhezhao').css('top',temp_height-50);
   $('.zhezhao').css('left',0);
  //初始化城市列表位置
   
   $('.citylist').css('top',temp_height+120);
   $('.citylist').css('margin-left','11px');//'Number(pos.left));
   $('.citylist2').css('top',temp_height+120);
   $('.citylist2').css('margin-left','-130px');
    $('.search_result').css('top',temp_height+120);
   $('.search_result').css('margin-left','11px');
