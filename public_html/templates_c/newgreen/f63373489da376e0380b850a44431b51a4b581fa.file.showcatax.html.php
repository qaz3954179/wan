<?php /* Smarty version Smarty-3.1.10, created on 2014-11-09 11:19:56
         compiled from "/www/web/www_wanfeng365_com/public_html/templates/newgreen/site/showcatax.html" */ ?>
<?php /*%%SmartyHeaderCode:359846397545edd5c604274-12331052%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f63373489da376e0380b850a44431b51a4b581fa' => 
    array (
      0 => '/www/web/www_wanfeng365_com/public_html/templates/newgreen/site/showcatax.html',
      1 => 1414934718,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '359846397545edd5c604274-12331052',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_545edd5c9261f9_73454730',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545edd5c9261f9_73454730')) {function content_545edd5c9261f9_73454730($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/www/web/www_wanfeng365_com/public_html/lib/Smarty/libs/plugins/modifier.date_format.php';
...
'; 
	 var nowtime = '<?php echo $_smarty_tpl->tpl_vars['nowdaytime']->value;?>
';
...
'; 
	  var maketime = '<?php echo $_smarty_tpl->tpl_vars['yanchitime']->value;?>
';
	   var nowdate = '<?php echo $_smarty_tpl->tpl_vars['nowdaymy']->value;?>
';
...
"  size="15">
   	...
   	<span class="hc_order_lists_span" id="uphone" >商品到时将以该电话通知您</span>
	</div>
	<div class="cart_out_show"> 
		<label >联 系 人:</label>
		...
		<label >配送时间:</label>
		 <select name="senddate"  style="width: 232px;margin:0px; height:30px; border-radius: 4px 4px 4px 4px;" onchange="maketimenenu();">
								   	 <?php if ($_smarty_tpl->tpl_vars['shopinfo']->value['befortime']>0){?>
								   	    <?php $_smarty_tpl->tpl_vars['shownow'] = new Smarty_variable(strtotime("now"), null, 0);?>   
